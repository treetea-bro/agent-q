...
""",
    ...
    You job is to output a boolean to tell if the objective has been achieved by looking at the screenshot VERY CAREFULLY. Return a single boolean is_terminal as true if user's objective has been achieved by the AI agent and false otherwise""",
    "EVAL_AGENT_PROMPT": """
